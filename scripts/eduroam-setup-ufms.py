...
Config.instname = "UFMS - Federal University of Mato Grosso do Sul"
Config.profilename = "UFMS - Federal University of Mato Grosso do Sul"
Config.url = "your local eduroam® support page"
Config.email = "your local eduroam® support"
Config.title = "eduroam CAT"
Config.server_match = "radius4.ufms.br"
...
Config.user_realm = "ufms.br"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:radius4.ufms.br']
